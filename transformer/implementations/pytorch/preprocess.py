...
def encode_and_save_files_utf8(subtokenizer, data_dir, raw_files, tag, total_shards):
  ...
  #if tag == _TRAIN_TAG:
  #  mlperf_print(key=mlperf_compliance.tags.PREPROC_NUM_TRAIN_EXAMPLES, value=counter)
  #elif tag == _EVAL_TAG:
  #  mlperf_print(key=mlperf_compliance.tags.PREPROC_NUM_EVAL_EXAMPLES, value=counter)
...
def main(unused_argv):
  ...
  test_files = [FLAGS.data_dir + '/newstest2014.en', FLAGS.data_dir + '/newstest2014.de']
