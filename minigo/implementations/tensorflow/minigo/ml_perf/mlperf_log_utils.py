...
def mlperf_submission_log(benchmark):
    ...
    framework = "TensorFlow NVIDIA Release {}".format(os.environ["NVIDIA_TENSORFLOW_VERSION"]);
    ...
    mlperf_compliance.mlperf_log.mlperf_print(
        ...
        value='{}x{}'.format(num_nodes,hardware))
    ...
    mlperf_compliance.mlperf_log.mlperf_print(
        ...
        value='c@lambdalabs.com')


if __name__ == '__main__':
    framework = "Tensorflow NGC {}".format(os.environ["NVIDIA_TENSORFLOW_VERSION"])
    benchmark = mlperf_compliance.constants.MINIGO
    mlperf_submission_log(benchmark, framework)
